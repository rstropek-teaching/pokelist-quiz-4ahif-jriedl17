...
var pokeAPILink = "https://pokeapi.co/api/v2/pokemon/?limit=20&offset=0";
function setHtmlPage() {
    return __awaiter(this, void 0, void 0, function () {
        var response, pokeList, table, _i, _a, pokemon;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    $("#pokemonDetails").hide();
                    return [4 /*yield*/, fetch(pokeAPILink)];
                case 1:
                    response = _b.sent();
...
function pageChange(buttonClicked) {
    return __awaiter(this, void 0, void 0, function () {
        var response, pokeList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch(pokeAPILink)];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
...
function getDetails(detailsURL) {
    return __awaiter(this, void 0, void 0, function () {
        var response, requestPokemon, _i, _a, ability;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    $("#pokemonDetails").show();
                ...
                case 2:
                    ...
                    $("#pokeAbilities").text("");
                    for (_i = 0, _a = requestPokemon.abilities; _i < _a.length; _i++) {
                        ability = _a[_i];
